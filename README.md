...
This folder contains files for the publication [7](https://www.sciencedirect.com/science/article/abs/pii/S0010465520302393) including two parts: the source code and the input data for the validation of the proposed computational scheme.
...
- `util.c` and `util.h` are used for benchmark
